...
public:
    ...
    msg_type gather(icontext_type& context, const vertex_type& vertex,
        ...
        gather_msg.ans.vec_op_mul_update(other.data().ans, edge.data().dist);
        return gather_msg;
    }
    ...
    void apply(icontext_type& context, vertex_type& vertex,
        ...
        vertex.data().ans.vec_op_set_mask(msg_accum.track, msg_accum.ans);
    }
    ...
    void scatter(icontext_type& context, const vertex_type& vertex, edge_type& edge) const {
        const vertex_type other = get_other_vertex(edge, vertex);
        msg_type msg(vertex.data().ans, vp_track);
