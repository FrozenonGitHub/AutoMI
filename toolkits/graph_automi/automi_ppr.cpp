...
struct msg_type {
    ...
    msg_type(const graphlab::automi_bitvec<ans_type>& ans_in) : ans(ans_in) {}
...
public:
    ...
    void apply(icontext_type& context, vertex_type& vertex,
        ...
        vertex.data().ans.vec_op_mul_update(msg_accum.ans, DAMP_FACTOR);
        vertex.data().ans.vec_op_add_update_mask(vertex.data().identity, 1.0 - DAMP_FACTOR);
    }
...
int main(int argc, char** argv) {
  ...
  graphlab::command_line_options 
    clopts("AutoMI personalized PageRank Algorithm.");
