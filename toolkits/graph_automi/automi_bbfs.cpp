...
struct msg_type {
    ...
    explicit msg_type(const graphlab::automi_bitvec<ans_type>& ans_in) : ans(ans_in) { }
...
public:
    ...
    void apply(icontext_type& context, vertex_type& vertex,
        ...
        changed.vec_op_andnot_update(vertex.data().ans, msg_accum.ans);
        vertex.data().ans.vec_op_or_update(msg_accum.ans);
    }
