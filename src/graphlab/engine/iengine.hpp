...
namespace graphlab {
  ...
  public:
    ...
    // when running a set of queries in singleton mode,
    // call engine_ptr->reset() to reset all vertex values
    virtual void reset() {}

    // when initializing source vertices,
    // call engine_ptr->signal_source(vertex_id)
    // not using pure virtual function here.
    virtual void signal_source(vertex_id_type vertex,
