...
#include <graphlab/util/dimitra_automaton.hpp>
#include <graphlab/util/dimitra_automaton_bk.hpp>
...
namespace graphlab {
  ...
  public:
    ...
    //
    virtual void reset(icontext_type& context, const vertex_type& vertex) {};

    virtual void postround(icontext_type& context, const vertex_type& vertex) {};

    virtual void source_init(icontext_type &context, vertex_type &vertex, const message_type& msg){};
